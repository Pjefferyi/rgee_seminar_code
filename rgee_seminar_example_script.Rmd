...
This process is usually a bit simpler than what is shown below. There is currently a known issue related to the ee$Initialize() function, so I have to work around it. 
